...
class Vector3 {
    ...
    magnitude() {
        ...
        m = (this.elements[0]**2 + this.elements[1]**2 + this.elements[2]**2)**.5
    ...
    normalize() {
        ...
        var x = this.elements[0] / this.magnitude()
        var y = this.elements[1] / this.magnitude()
        var z = this.elements[2] / this.magnitude()
